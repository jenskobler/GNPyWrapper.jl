"""
ONLY COPY PASTE PURPOSE

TODO: UPDATE AND CHECK the following code!

TODO: Clean up the following coda (make it pretty)

TODO: Write Documentation/Comments!

TODO: Make the following comparable to the original gnpy cli function (for that use if statements with (if not IGNORE) to include original code )
